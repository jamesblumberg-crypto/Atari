...
dlist
	; Status line uses CHBAS (outdoor): letters 86-111 and corners 10-15
	; are intact there. DLI on the status line itself switches to the
	; dungeon set for the playfield; dli2 switches back for the bottom.
